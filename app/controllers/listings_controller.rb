class ListingsController < ApplicationController
  ...
  before_action :set_listing, only: [ :update, :basics, :description, :address, :price, :photos,
  :calendar, :bankaccount, :publish ]
  def index
  end
  ...
  def update
    if @listing.update(listing_params)
      redirect_back(fallback_location: manage_listing_price_path, notice: "更新しました")
    end
  end
